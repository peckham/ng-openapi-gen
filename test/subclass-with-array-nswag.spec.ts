...
import options from './subclass-with-array-nswag.config.json';
import subclassWithArraySpec from './subclass-with-array-nswag.json';

const gen = new NgOpenApiGen(subclassWithArraySpec, options);
gen.generate();

describe('Generation tests using subclass-with-array-nswag.json', () => {
